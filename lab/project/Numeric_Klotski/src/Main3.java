...
public class Main3 {
    ...
    private static class Node{
        ...
        public Node(int[][] Array,int N,int M,int numberOfblock,int[][] sizeOfBlock,Node Father){
            ...
            //这里必须这么左，不然会出现空指针的情况
            this.block1=initBlock1(numberOfblock);
            this.block2=initBlock2(numberOfblock);
            this.block3=initBlock3(numberOfblock);
    ...
    public static boolean isComplete(Node state){
        ...
        if(worryofzeros!=0){
            ...
            for(int i=0;i<arrayofdecide.length-numberOfZero;i++){
                if(arrayofdecide[i]==i+1){
                ...
                for(int i=0;i<n;i++){
                    for(int j=0;j<m;j++){
                        if(currentState.array[i][j]==0){
                            ...
                            //与左面能否交换后的结果
                            Node next3= left(currentState, i, j);
                            printState(next3);
                            ...
                            //与右面能否交换后的结果
                            Node next4= right(currentState, i, j);
                            printState(next4);
